...
default_args={
    "owner": "brajesh.jaishwal@gmail.com,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-12-19", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "brajesh.jaishwal@gmail.com": "mailto:brajesh.jaishwal@gmail.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm4vcsh8l0g9301ktnrcbxlqq/cloud-ide/cm4vcuz6m0g9h01ktgigg8fje/cm4vcuzop0h0801lc5tw76yt3",
    },
)
